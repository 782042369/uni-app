...
<p align="center">
  ...
  <a href="https://uni-helper.js.org/vitesse-uni-app">📖 官方文档</a>
...
>
> - [快速开始](./docs/GETTING_STARTED.md) - 环境准备和安装
> - [脚本参考](./docs/SCRIPTS.md) - 所有可用命令
> - [构建指南](./docs/BUILD.md) - 多平台打包流程
> - [开发工作流](./docs/CONTRIB.md) - 代码规范和 Git 流程
